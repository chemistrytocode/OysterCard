...
describe Oystercard do
  ...
  describe '#touch_in methods' do
    # it 'Should deduct balance by the PENALTY_FARE if customer touchs in without touching out' do
    #   subject.top_up(10)
  ...
  describe '#touch out methods' do
    it 'Should deduct the minimum fare on touching out' do
      ...
      subject.touch_in(start_station)
      expect{subject.touch_out(end_station)}.to change{subject.balance}.by -Oystercard::MINIMUM_FARE
    end
